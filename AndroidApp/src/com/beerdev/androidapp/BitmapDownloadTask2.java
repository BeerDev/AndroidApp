...
class BitmapDownloadTask2 extends AsyncTask<Void, Void, Void> {
	...
	protected void onPreExecute() {
		...
		fileCache = new FileCache(FragmentManagerActivity.globalContext);
	...
	protected Void doInBackground(Void... arg0) {
		...
		for (int i = 1; i < MainActivity.completeProductList.size(); i+=2) {
